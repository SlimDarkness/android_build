...
# Copyright (C) 2012-2015, SlimDarkness Project
#
...
org_manifest = "SlimDarkness"  # leave empty if org is provided in manifest
org_display = "SlimDarkness"  # needed for displaying
